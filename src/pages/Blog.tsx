              ...
              <div className="grid gap-6">
                {visiblePosts.map((post) => {
                  ...
                  return (
                    <article
                      key={post.id}
                      className="bg-pink-50 rounded-lg p-6 border-2 border-purple-200 hover-lift"
                    >
                      {post.coverImage && (
                        <div className="mb-4 overflow-hidden rounded-lg border-2 border-purple-200 image-overlay">
                          <img
                            src={post.coverImage}
                            alt={post.title}
                            className="w-full h-48 object-cover scale-on-hover"
                            loading="lazy"
                            decoding="async"
                            width={1200}
                            height={480}
